...
from ..utils.lora.adaptive_dropout import inject_adaptive_dropout_lora, get_lora_state_dict
...
class DiffusionTrainingModule(torch.nn.Module):
    ...
    def add_lora_to_model(self, model, target_modules, lora_rank, lora_alpha=None, upcast_dtype=None,
                          use_adaptive_dropout=False, dropout=None, rank_dropout=None, module_dropout=None):
        """
        Add LoRA layers to a model.
        ...
        Args:
            ...
            upcast_dtype: Data type for trainable parameters
            use_adaptive_dropout: Whether to use AdaptiveDropout LoRA
            dropout: Neuron dropout probability (for AdaptiveDropout)
            rank_dropout: Rank dropout probability (for AdaptiveDropout)
            module_dropout: Module dropout probability (for AdaptiveDropout)
        ...
        if use_adaptive_dropout:
            # Use AdaptiveDropout LoRA
            model = inject_adaptive_dropout_lora(
                model=model,
    ...
    def switch_pipe_to_training_mode(
        ...
        """
        Switch pipeline to training mode.
        
        Args:
            pipe: Pipeline object
            trainable_models: Models to train
            lora_base_model: Base model to add LoRA
            lora_target_modules: Target modules for LoRA
            lora_rank: LoRA rank
            lora_checkpoint: Path to LoRA checkpoint
            preset_lora_path: Path to preset LoRA
            preset_lora_model: Model for preset LoRA
            task: Training task
            use_adaptive_dropout: Whether to use AdaptiveDropout LoRA
        ...
        if lora_base_model is not None and not task.endswith(":data_process"):
            ...
            if use_adaptive_dropout:
                print(f"Using AdaptiveDropout LoRA: dropout={dropout}, rank_dropout={rank_dropout}, module_dropout={module_dropout}")
