#!/bin/bash
# Z-Image-Turbo LoRA Training with AdaptiveDropout
#
# This script demonstrates how to train Z-Image-Turbo LoRA with AdaptiveDropout method.
...
#
# Usage: bash Z-Image-Turbo-AdaptiveDropout.sh
...
OUTPUT_PATH="./outputs/z_image_lora_adaptive_dropout"
LORA_RANK=32
LEARNING_RATE=1e-4
NUM_EPOCHS=10

# AdaptiveDropout configuration
# Z-Image-Turbo is a distilled model, so we use slightly lower dropout rates
RANK_DROPOUT=0.15
MODULE_DROPOUT=0.05
DROPOUT=0.0
